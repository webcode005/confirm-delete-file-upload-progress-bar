    ...
    <div class="row">
        <div class="col-lg-12">
                <img src="https://www.mindcypress.com/assets/images/common/mindcypress-new-logo.png" class="img-responsive center-block d-block mx-auto" alt="Sample Image">
                 <h2 class="text-center"><span class="glyphicon glyphicon-cloud-upload" style="font-size:30px;"></span> Upload File</h2>
            </div>
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <form class="form-inline"  id="uploadForm" action="upload.php" method="post">
                    <div class="form-group">
                        <label>Upload File:</label>
                        <input name="userImage" id="userImage" type="file" class="demoInputBox form-control" required/>
                    </div>
